...
cp "$project_root/packaging/changelog.Debian" "$package_root/usr/share/doc/advanced-ip-analyser/changelog.Debian"
...
gzip -9n "$package_root/usr/share/doc/advanced-ip-analyser/changelog.Debian"
